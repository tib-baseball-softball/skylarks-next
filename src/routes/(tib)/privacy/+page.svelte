<!-- @wc-ignore -->
<article class="prose max-w-none mb-6" lang="de"><h1 class="mt-4">Datenschutzerklärung</h1>
  ...
  <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen
    ...
    Datenschutzerklärung entnehmen.</p> <h4>Wie erfassen wir Ihre Daten?</h4>
  ...
  <p>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch
    ...
    Website betreten.</p> <h4>Wofür nutzen wir Ihre Daten?</h4>
  ...
  <p>Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer
    ...
    zu.</p>
  <p>Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit an uns
    wenden.</p>
  <h2>2. Hosting</h2>
...
noreferrer" target="_blank">https://www.hetzner.com/de/legal/privacy-policy/</a>.</p>
  ...
  <p>Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung
  ...
  <p>Im Rahmen unserer Geschäftstätigkeit
  ...
  <p>Viele Datenverarbeitungsvorgänge sind
  ...
  <p>Sie haben das Recht, die Einschränkung der
  ...
  <p>Diese Seite nutzt aus Sicherheitsgründen und zum Schutz
  ...
  <p>Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert ist,
