    ...
    <form onsubmit={submitForm} class="mt-4 space-y-3">
        ...
        <label class="label">
            ...
            <span class="grid grid-cols-[auto_1fr] gap-2">
                ...
                <input class="input" type="text" bind:value={form.cap} tabindex="-1"/>
            </span>
        </label>
        ...
        <label class="label">
            ...
            <span class="grid grid-cols-[auto_1fr] gap-2">
                ...
                <input class="input" type="text" bind:value={form.jersey} tabindex="-1"/>
            </span>
        </label>
        ...
        <label class="label">
            ...
            <span class="grid grid-cols-[auto_1fr] gap-2">
                ...
                <input class="input" type="text" bind:value={form.pants} tabindex="-1"/>
            </span>
        </label>
