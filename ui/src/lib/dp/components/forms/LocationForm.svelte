  ...
  <form class="edit-form" onsubmit={submitForm}>
    <div class="edit-form-grid">
      ...
      <div class="field-wide">
        ...
        />
        <span class="subdued"
          >Custom name field that will not be overwritten by automatic imports.</span
        >
      </div>
      ...
      <label class="field-wide">
        Coordinate Map
        <span class="subdued"
          >Select a location on the map to set coordinates automatically</span
        >
        <LeafletMapCoordinatePicker
