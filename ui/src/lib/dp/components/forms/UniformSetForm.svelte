<script lang="ts">
  ...
  function formFromProps(
    data: UniformsetsResponse | null | undefined,
  ): UniformsetsCreate {
    return (
      data ?? {
        id: "",
...
<form onsubmit={submitForm}>
  ...
  <div class="hint">
    You can use the special identifiers <code class="code">B</code> and
    <code class="code">Bird</code> to get the Skylarks Home and Road Cap instead of
    a generic colored one.
  </div>
