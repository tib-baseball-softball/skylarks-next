<script lang="ts">
  ...
  import JoinTeamForm from "$lib/dp/components/forms/JoinTeamForm.svelte";
...
<div class="join-grid">
  <article class="card join-container preset-outlined-card">
    <h3 class="h4">
      Join Team
    </h3>
    <div>
      <JoinTeamForm {authRecord} {teamID}/>
    </div>
  </article>
</div>
