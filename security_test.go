...
var alligatorInternalEvent = recordData{
	ID:   "2nk3dmprg93nv0z",
	Name: "Alligator Event - no additional teams",
}
...
func TestAPIRules(t *testing.T) {
	...
	scenarios := []tests.ApiScenario{
		...
		{
			Name:   "Member cannot edit their own team event (Antelopes)",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aliceToken,
			},
			Body:            strings.NewReader(`{"title":"CHANGED_A"}`),
			ExpectedStatus:  http.StatusNotFound,
			ExpectedContent: []string{"The requested resource wasn't found."},
			TestAppFactory:  setupTestApp,
		},
		{
			Name:   "Member cannot edit other team's event",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + beeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aliceToken,
			},
			Body:            strings.NewReader(`{"title":"CHANGED_A"}`),
		...
		{
			Name:   "Team admin can edit their own team event (Antelopes)",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": andreaToken,
			},
			Body:            strings.NewReader(`{"title":"EVENT_CHANGED_A"}`),
			ExpectedStatus:  http.StatusOK,
			ExpectedContent: []string{`"collectionName":"events"`, `"title":"EVENT_CHANGED_A"`},
			TestAppFactory:  setupTestApp,
		},
		{
			Name:   "Team admin can edit another team's event where own team is set as 'additional'",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + alligatorEventForAntelopes.ID,
			Headers: map[string]string{
				"Authorization": andreaToken,
		...
		{
			Name:   "Team admin cannot edit another team's event where own team is not set as 'additional'",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + alligatorInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": andreaToken,
		...
		{
			Name:   "Club admin can edit their own club team event (Antelopes)",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aClubAdminToken,
		...
		{
			Name:   "Club admin cannot edit another club's event",
			Method: http.MethodPatch,
			URL:    "/api/collections/events/records/" + clubBEvent.ID,
			Headers: map[string]string{
				"Authorization": aClubAdminToken,
			},
			Body:            strings.NewReader(`{"title":"CHANGED_A"}`),
		...
		{
			Name:   "Team member cannot delete events",
			Method: http.MethodDelete,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aliceToken,
		...
		{
			Name:   "Team admin can delete events for own team",
			Method: http.MethodDelete,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": andreaToken,
		...
		{
			Name:   "Team admin cannot delete events for another team even if additional_teams is set",
			Method: http.MethodDelete,
			URL:    "/api/collections/events/records/" + alligatorEventForAntelopes.ID,
			Headers: map[string]string{
				"Authorization": andreaToken,
		...
		{
			Name:   "Club admin can delete events for team in own club",
			Method: http.MethodDelete,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aClubAdminToken,
		...
		{
			Name:   "Club admin can delete club-wide events for own club",
			Method: http.MethodDelete,
			URL:    "/api/collections/events/records/" + antelopeInternalEvent.ID,
			Headers: map[string]string{
				"Authorization": aClubAdminToken,
